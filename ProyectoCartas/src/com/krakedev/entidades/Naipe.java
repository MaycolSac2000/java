...
public class Naipe {
	...
	public Naipe() {
		...
		for (int i = 0; i < numerosPosibles.size(); i++) {
			...
			cartas.add(new Carta(elementoNumero, "CR"));
			cartas.add(new Carta(elementoNumero, "CN"));
			cartas.add(new Carta(elementoNumero, "DI"));
			cartas.add(new Carta(elementoNumero, "TR"));
